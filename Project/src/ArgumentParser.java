...
public class ArgumentParser {
	...
	public static boolean isValue(String arg) {
		return arg != null && arg.startsWith("-") != true && arg.isEmpty() != true;
	}
	 ...
	 */
	public int getInt(String flag, int threads) {
		String value = getString(flag);
		try {
			...
			System.out.println("Value of threads is not an integer! Using default threads...");
		}
		return threads;
	}
